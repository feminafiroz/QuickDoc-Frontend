      ...
      {isVerified ? (
        <div className=" bg-emerald-200 flex justify-center items-center min-h-screen ">
          <div className="bg-white shadow-lg rounded-lg p-8 max-w-md border">
            ...
            <button
              className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-full w-full focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
        ...
        <div className="flex justify-center items-center min-h-screen bg-emerald-100">
          <div className="bg-white shadow-lg rounded-lg p-8 max-w-md border">
            ...
            <button
              className="bg-green-700 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-full w-full focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
              onClick={verifyEmail}
            >
              Verify
            </button>
