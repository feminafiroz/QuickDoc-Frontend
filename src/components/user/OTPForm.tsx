...
const OTPForm: React.FC = () => {
  ...
  return (
    ...
    >
        <div className="w-96 p-8 bg-gray-100 bg-opacity-80 rounded-lg shadow-lg">
          <h2 className="font-bold text-black-400 text-3xl ml-20 mb-2">
            Verify OTP
          </h2>
          <p className="mt-2 text-xs text-black-900 ml-12 mb-6">
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-green-700 ml-28 mt-3 hover:bg-green-600 text-white font-bold py-2 px-6 rounded-lg focus:outline-none focus:shadow-outline"
            >
              Verify
            </button>
